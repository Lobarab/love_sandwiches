...
def get_sales_data():
    ...
    """
    while True:
         print("Please enter last data from the sales market")
...
def update_surplus_worksheet(data):
    ...
    print("Surpluss worksheet updated successfully.\n")     


def calculate_surplus_data(sales_row):
    """
    Compare sales with stock and calculate the surplus type for each item.
